...
function App() {
  ...
  return (
    <div className="App p-5">
      <form className="flex flex-col gap-4 shadow-md h-fit mb-5 bg-black/20 p-2" onSubmit={login}>
        <input
          onChange={(event) =>
      ...
      <div className=" bg-black/70 p-2 flex flex-col gap-y-2">
      ...
      >
        {tasks?.map((data) => (
          <li
            className={`
            shadow-md px-2 py-1 rounded-sm hover:scale-105 hover:shadow-sm duration-75 flex gap-x-5 px-5 py-2
